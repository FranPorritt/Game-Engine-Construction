...
{
	int right1 = entity1.GetRect().right + position.xPos;
	int left1 = entity1.GetRect().left + position.xPos;
	int top1 = entity1.GetRect().top + position.yPos;
	int bottom1 = entity1.GetRect().bottom + position.yPos;
	...
	if (top2 < 384) // Top half of screen -- Need seperate ones because of view angle
	{
